document.addEventListener("DOMContentLoaded", function () {
    let btn = $('<button id="newBtn">Click me for a NICE message</button>');
    $('body').append(btn);
    ...
    $(document).ready(function () {
        ...
        let myDiv = $('<div id="newDiv">this a div</div>');
        $('body').append(myDiv);
        ...
        let p = $('<p id="para"></p>');
        $('body').append(p);
        $(p).text("Roses are red, violets are blue. Please click me and I will change hue.");
        ...
        let btn2 = $('<button id="btn2">hello i forgot my name</button>');
        $('body').append(btn2)
        let div2 = $('<div></div>');
        $('body').append(div2);
